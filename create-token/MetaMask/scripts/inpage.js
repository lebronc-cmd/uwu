!function e(t, r, n) {
        ...
        (function(t) {
            (function() {
                ...
                var r = f(e("loglevel"))
                  ...
                  , o = f(e("@metamask/object-multiplex"))
                  , a = e("readable-stream")
                  , c = e("@metamask/multichain-api-client")
                  , u = e("@metamask/solana-wallet-standard")
                  , l = f(e("../../shared/modules/provider-injection"))
                  , d = e("./constants/stream");
                function f(e) {
                ...
                l.default)()) {
                    ...
                    (0,
                    a.pipeline)(e, t, e, e => {
                        let t = `Lost connection to "${d.METAMASK_EIP_1193_PROVIDER}".`;
                        null != e && e.stack && (t += `\n${e.stack}`),
                        console.warn(t)
                    }
                    ),
                    ...
                    i.initializeProvider)({
                        connectionStream: t.createStream(d.METAMASK_EIP_1193_PROVIDER),
                        logger: r.default,
                        shouldShimWeb3: !0,
                        providerInfo: {
                            uuid: (0,
                    ...
                    const l = (0,
                    c.getMultichainClient)({
                        transport: (0,
                        c.getDefaultTransport)()
                    });
                    (0,
                    u.registerSolanaWalletStandard)({
                        client: l,
                        walletName: "MetaMask"
                    })
                }
    ...
    , {
        ...
        "@metamask/solana-wallet-standard": 52,
        loglevel: 118,
        "readable-stream": 139,
        uuid: 188
    }],
    3: [function(e, t, r) {
        "use strict";
        var n, s, i, o, a, c, u, l, d, f, h, p, g, m = this && this.__classPrivateFieldSet || function(e, t, r, n, s) {
            if ("m" === n)
        ...
        const b = e("@metamask/rpc-errors")
          , v = w(e("@metamask/safe-event-emitter"))
          , E = e("@metamask/utils");
        class _ extends v.default {
            ...
            asMiddleware() {
                ...
                async (e, t, r, n) => {
                    try {
                        const [i,a,c] = await y(s, s, "m", f).call(s, e, t, y(this, o, "f"));
                        return a ? (await y(s, s, "m", p).call(s, c),
                        n(i)) : r(async e => {
                            try {
                                await y(s, s, "m", p).call(s, c)
                            } catch (t) {
                                return e(t)
                            }
                            return e()
            ...
            try {
                if (0 === e.length) {
                    const e = [{
                        id: null,
                        jsonrpc: "2.0",
                        error: new b.JsonRpcError(b.errorCodes.rpc.invalidRequest,"Request batch must contain plain objects. Received an empty array")
                    }];
                    return t ? t(null, e) : e
                }
        ...
        l = async function(e, t) {
            if (!e || Array.isArray(e) || "object" != typeof e) {
                const r = new b.JsonRpcError(b.errorCodes.rpc.invalidRequest,"Requests must be plain objects. Received: " + typeof e,{
                    request: e
                });
                return t(r, {
                    id: null,
            ...
            if ("string" != typeof e.method) {
                const r = new b.JsonRpcError(b.errorCodes.rpc.invalidRequest,"Must specify a string method. Received: " + typeof e.method,{
                    request: e
                });
                return y(this, a, "f") && !(0,
            ...
            try {
                await y(s, s, "m", d).call(s, n, i, y(this, o, "f"))
            } catch (e) {
                r = e
            }
        ...
        d = async function(e, t, r) {
            const [n,i,o] = await y(s, s, "m", f).call(s, e, t, r);
            if (y(s, s, "m", g).call(s, e, t, i),
            await y(s, s, "m", p).call(s, o),
            n)
                throw n
        }
        ,
        f = async function(e, t, r) {
            ...
            let i = null
              , o = !1;
            for (const a of r)
                if ([i,o] = await y(s, s, "m", h).call(s, e, t, a, n),
                o)
                    break;
        ...
        h = async function(e, t, r, n) {
            return new Promise(s => {
                const i = e => {
                  ...
                  , o = r => {
                    t.error ? i(t.error) : (r && ("function" != typeof r && i(new b.JsonRpcError(b.errorCodes.rpc.internal,`JsonRpcEngine: "next" return handlers must be functions. Received "${typeof r}" for request:\n${S(e)}`,{
                        request: e
                    })),
                    n.push(r)),
                    s([null, !1]))
        ...
        g = function(e, t, r) {
            ...
            E.hasProperty)(t, "error"))
                throw new b.JsonRpcError(b.errorCodes.rpc.internal,`JsonRpcEngine: Response has no error or result for request:\n${S(e)}`,{
                    request: e
                });
            if (!r)
                throw new b.JsonRpcError(b.errorCodes.rpc.internal,`JsonRpcEngine: Nothing ended request:\n${S(e)}`,{
                    request: e
                })
        }
    }
    , {
        "@metamask/rpc-errors": 48,
        "@metamask/safe-event-emitter": 50,
        "@metamask/utils": 74
    }],
    4: [function(e, t, r) {
        "use strict";
    ...
    13: [function(e, t, r) {
            ...
            return new Promise( (e, t) => {
                const r = t => {
                    if (function(e) {
                        ...
                        return t === n.INPAGE && r?.name === s.METAMASK_PROVIDER_STREAM_NAME && e.origin === location.origin
                    }(t)) {
                        const s = t?.data?.data?.data;
                        if (s?.method === n.METAMASK_EXTENSION_CONNECT_CAN_RETRY)
                            i();
                        else if (s?.result?.extensionId) {
                            const t = s?.result?.extensionId;
                            e(t),
        ...
        const n = e("../transports/constants.cjs")
          , s = e("../transports/constants.cjs");
        function i() {
            window.postMessage({
                target: n.CONTENT_SCRIPT,
                data: {
                    name: s.METAMASK_PROVIDER_STREAM_NAME,
                    data: {
    ...
    14: [function(e, t, r) {
        ...
        r.withRetry = async function(e, t={}) {
            const {maxRetries: r=10, requestTimeout: n=200, retryDelay: s=n} = t
              , i = "Timeout reached";
            for (let t = 0; t <= r; t++)
                try {
                    const t = new Promise( (e, t) => {
                        setTimeout( () => t(new Error(i)), n)
                    }
                    );
                    ...
                    if (t >= r)
                        throw e;
                    e instanceof Error && e.message !== i && await new Promise(e => setTimeout(e, s))
                }
    ...
    15: [function(e, t, r) {
        ...
        r.getDefaultTransport = function(e={}) {
            ...
            c.getWindowPostMessageTransport)()
        }
        ;
        const i = e("./helpers/utils.cjs")
          , o = e("./multichainClient.cjs");
        Object.defineProperty(r, "getMultichainClient", {
            enumerable: !0,
            get: function() {
                return o.getMultichainClient
            }
        });
        ...
        const c = e("./transports/windowPostMessageTransport.cjs");
        Object.defineProperty(r, "getWindowPostMessageTransport", {
            enumerable: !0,
            get: function() {
                return c.getWindowPostMessageTransport
            }
        }),
        s(e("./types/errors.cjs"), r)
    }
    , {
    ...
    16: [function(e, t, r) {
        ...
        const n = e("./helpers/utils.cjs")
          , s = e("./types/errors.cjs");
        async function i({transport: e, method: t, params: r}) {
            const n = await e.request({
                method: t,
                params: r
            });
            if (n?.error)
                throw new s.MultichainApiError(n.error);
            return n.result
        }
    }
    , {
            ...
            return {
                connect: async () => {
                    try {
                        ...
                        throw new s.TransportError("Failed to connect to MetaMask",e)
                    }
                }
                ,
                disconnect: async () => {
                ...
                request: e => {
                    const r = t;
                    if (!r)
                        throw new s.TransportError("Chrome port not connected");
                    const n = o++
                      , c = {
                        id: n,
                        jsonrpc: "2.0",
        ...
        r.getWindowPostMessageTransport = function() {
            ...
            return {
                connect: async () => {
                    ...
                    e = e => {
                        const {target: t, data: r} = e.data;
                        t === s.INPAGE && r?.name === s.MULTICHAIN_SUBSTREAM_NAME && e.origin === location.origin && o(r.data)
                    }
                    ,
                ...
                request: e => {
                    ...
                    return new Promise(e => {
                        ...
                        function(e) {
                            window.postMessage({
                                target: s.CONTENT_SCRIPT,
                                data: {
                                    name: s.MULTICHAIN_SUBSTREAM_NAME,
                                    data: e
                                }
                            }, location.origin)
                        }(o)
    ...
    21: [function(e, t, r) {
        ...
        class c extends s.Duplex {
            ...
            createStream(e, t={}) {
                ...
                const r = new o.Substream(Object.assign({
                    name: e,
                    parent: this
                }, t));
    ...
    25: [function(e, t, r) {
        ...
        s(e("./window/WindowPostMessageStream.cjs"), r),
        s(e("./web-worker/WebWorkerPostMessageStream.cjs"), r),
        s(e("./web-worker/WebWorkerParentPostMessageStream.cjs"), r),
        s(e("./runtime/BrowserRuntimePostMessageStream.cjs"), r),
        s(e("./BasePostMessageStream.cjs"), r);
        var i = e("./utils.cjs");
        Object.defineProperty(r, "isValidStreamMessage", {
            enumerable: !0,
            get: function() {
                return i.isValidStreamMessage
            }
        })
    }
    , {
    ...
    26: [function(e, t, r) {
        ...
        const c = e("../BasePostMessageStream.cjs")
          , u = e("../utils.cjs");
    ...
    28: [function(e, t, r) {
        ...
        const s = e("../BasePostMessageStream.cjs")
          , i = e("../utils.cjs");
    ...
    31: [function(e, t, r) {
        ...
        class p extends l.default {
            ...
            _handleChainChanged({chainId: e, isConnected: t}={}) {
                ...
                this._state.initialized && this.emit("chainChanged", o(this, n, "f")))) : this._log.error(f.default.errors.invalidNetworkParams(), {
                    chainId: e
                })
            }
    ...
    32: [function(e, t, r) {
        ...
        r.announceWallet = function(e) {
            a(e) || c(`Invalid CAIP-294 WalletData object received from ${i.Prompt}.`);
            const t = () => window.dispatchEvent(new CustomEvent(i.Announce,{
                detail: {
                    id: 1,
                    jsonrpc: "2.0",
            ...
            t(),
            window.addEventListener(i.Prompt, e => {
                (function(e) {
                    return e instanceof CustomEvent && e.type === i.Prompt && (0,
                ...
                )(e) || c(`Invalid CAIP-294 RequestWalletEvent object received from ${i.Prompt}.`),
                t()
            }
            )
        }
        ...
        r.requestWallet = function(e) {
            window.addEventListener(i.Announce, t => {
                (function(e) {
                    return e instanceof CustomEvent && e.type === i.Announce && (0,
                    n.isObject)(e.detail) && "wallet_announce" === e.detail.method && a(e.detail.params)
                }
                )(t) || c(`Invalid CAIP-294 WalletData object received from ${i.Announce}.`),
                e(t.detail)
            }
            ),
            window.dispatchEvent(new CustomEvent(i.Prompt,{
                detail: {
                    id: 1,
                    jsonrpc: "2.0",
        ...
        function a(e) {
            return (0,
            n.isObject)(e) && "string" == typeof e.uuid && s.UUID_V4_REGEX.test(e.uuid) && "string" == typeof e.name && Boolean(e.name) && "string" == typeof e.icon && e.icon.startsWith("data:image") && "string" == typeof e.rdns && s.FQDN_REGEX.test(e.rdns) && (void 0 === e.targets || Array.isArray(e.targets) && e.targets.every(o))
        }
        function c(e) {
    ...
    33: [function(e, t, r) {
        ...
        r.requestProvider = function(e) {
            window.addEventListener(i.Announce, t => {
                (function(e) {
                    return e instanceof CustomEvent && e.type === i.Announce && Object.isFrozen(e.detail) && o(e.detail)
                }
                )(t) || a(`Invalid EIP-6963 AnnounceProviderEvent object received from ${i.Announce} event.`),
                e(t.detail)
            }
            ),
        ...
        r.announceProvider = function(e) {
            o(e) || a("Invalid EIP-6963 ProviderDetail object.");
            ...
            window.addEventListener(i.Request, e => {
                ...
                )(e) || a(`Invalid EIP-6963 RequestProviderEvent object received from ${i.Request} event.`),
                n()
            }
            )
        }
    ...
    34: [function(e, t, r) {
        ...
        class f extends l.AbstractStreamProvider {
            constructor(e, {logger: t=console, maxEventListeners: r=100, shouldSendMetadata: i}={}) {
                if (super(e, {
                    logger: t,
                    maxEventListeners: r,
                    rpcMiddleware: (0,
            ...
            _handleChainChanged({chainId: e, networkVersion: t, isConnected: r}={}) {
                ...
                const o = "loading" === t ? null : t;
                o !== i(this, n, "f") && (s(this, n, o, "f"),
    ...
    35: [function(e, t, r) {
        ...
        class l extends a.BaseProvider {
            constructor(e, {logger: t=console, maxEventListeners: r=100, rpcMiddleware: n=[]}={}) {
                ...
                (0,
                o.pipeline)(e, this._jsonRpcConnection.stream, e, this._handleStreamDisconnect.bind(this, "MetaMask RpcProvider")),
    ...
    37: [function(e, t, r) {
        ...
        r.initializeProvider = function({connectionStream: e, logger: t=console, maxEventListeners: r=100, providerInfo: n, shouldSendMetadata: u=!0, shouldSetOnWindow: l=!0, shouldShimWeb3: d=!1, shouldAnnounceCaip294: f=!0}) {
            const h = new i.MetaMaskInpageProvider(e,{
                logger: t,
                maxEventListeners: r,
        ...
        r.announceCaip294WalletData = c;
        const n = e("./CAIP294.cjs")
          , s = e("./EIP6963.cjs")
          , i = e("./MetaMaskInpageProvider.cjs")
          , o = e("./shimWeb3.cjs");
        function a(e) {
            try {
                window.ethereum = e,
    ...
    42: [function(e, t, r) {
        ...
        r.isValidNetworkVersion = e => "string" == typeof e && (o.test(e) || "loading" === e);
        r.NOOP = () => {}
    }
    , {
    ...
    52: [function(e, t, r) {
        ...
        const n = e("@wallet-standard/wallet")
          , s = e("./wallet.cjs");
        function i(e) {
            return new s.MetamaskWallet(e)
        }
    }
    , {
        "./wallet.cjs": 55,
        "@wallet-standard/wallet": 103
    }],
    53: [function(e, t, r) {
        "use strict";
        var n;
    ...
    54: [function(e, t, r) {
        ...
        r.getScopeFromWalletStandardChain = function(e) {
            ...
            case void 0:
                return s.Scope.MAINNET;
            case n.SOLANA_TESTNET_CHAIN:
                return s.Scope.TESTNET;
            case n.SOLANA_DEVNET_CHAIN:
                return s.Scope.DEVNET;
            default:
                if (s.scopes.includes(e))
                    return e;
    ...
    , {
        "./types.cjs": 53,
        "@solana/wallet-standard-chains": 92
    }],
    55: [function(e, t, r) {
        (function(t) {
            (function() {
                "use strict";
                var n, s, i, o, a, c, u, l, d, f, h, p, g, m, y, w, b, v, E, _ = this && this.__classPrivateFieldGet || function(e, t, r, n) {
                    if ("a" === r && !n)
                        throw new TypeError("Private accessor was defined without a getter");
                    if ("function" == typeof t ? e !== t || !n : !t.has(e))
                        throw new TypeError("Cannot read private member from an object whose class did not declare it");
                ...
                , S = this && this.__classPrivateFieldSet || function(e, t, r, n, s) {
                    if ("m" === n)
                        throw new TypeError("Private method is not writable");
                    if ("a" === n && !s)
                        throw new TypeError("Private accessor was defined without a setter");
                ...
                r.MetamaskWallet = class {
                        ...
                        return new Promise(e => {
                            ...
                            , 2e3)
                              , r = this.client.onNotification(n => {
                                if ((0,
                                T.isAccountChangedEvent)(n)) {
                                    const s = n?.params?.notification?.params?.[0];
                                    s && (clearTimeout(t),
                                    r?.(),
                                    e(s))
                                }
                    ...
                    get features() {
                        return {
                            ...
                            [A.SolanaSignAndSendTransaction]: {
                                ...
                                signAndSendTransaction: _(this, p, "f")
                            },
                            [A.SolanaSignTransaction]: {
                                version: this.version,
                                supportedTransactionVersions: ["legacy", 0],
                                signTransaction: _(this, g, "f")
                            },
                            [A.SolanaSignMessage]: {
                                version: this.version,
                                signMessage: _(this, m, "f")
                            }
                        }
                    }
                    constructor({client: e, walletName: r}) {
                        ...
                        o.set(this, void 0),
                        a.set(this, void 0),
                        c.set(this, (e, t) => (_(this, s, "f")[e] ? _(this, s, "f")[e]?.push(t) : _(this, s, "f")[e] = [t],
                        () => _(this, n, "m", l).call(this, e, t))),
                        d.set(this, async () => this.accounts.length ? {
                            accounts: this.accounts
                        } : (await _(this, v, "f").call(this),
                        this.accounts.length || await _(this, E, "f").call(this, N.Scope.MAINNET),
                        this.accounts.length ? (S(this, a, this.client.onNotification(_(this, n, "m", y).bind(this)), "f"),
                        {
                            accounts: this.accounts
                        }) : {
                            accounts: []
                        ...
                        f.set(this, async (...e) => {
                            if (!(_(this, o, "f") && this.scope || (await _(this, d, "f").call(this),
                            _(this, o, "f") && this.scope)))
                                ...
                                const e = await this.client.invokeMethod({
                                    ...
                                    request: {
                                        ...
                                        params: {
                                            ...
                                            address: n.address || _(this, o, "f").address
                                        }
                                    }
                                });
                                r.push({
                                    ...
                                    signature: R.default.decode(e.signature)
                                })
                            }
                            return r
                        }
                        ...
                        h.set(this, async (e={}) => {
                            ...
                            S(this, o, void 0, "f"),
                            this.scope = void 0,
                            _(this, a, "f")?.call(this),
                            S(this, a, void 0, "f"),
                            _(this, n, "m", u).call(this, "change", {
                                accounts: this.accounts
                            }),
                        ...
                        p.set(this, async (...e) => {
                            ...
                            if (!r)
                                throw new Error("Not connected");
                            _(this, b, "f").call(this, e);
                            const n = (0,
                            T.getScopeFromWalletStandardChain)(e[0]?.chain)
                              , s = await this.client.getSession()
                              , i = s?.sessionScopes[n]?.accounts;
                            i?.includes(`${n}:${r.address}`) ? this.scope = n : await _(this, E, "f").call(this, n, [r.address]);
                            const a = [];
                            for (const {transaction: r, account: s} of e) {
                                const e = t.from(r).toString("base64")
                                  , i = await this.client.invokeMethod({
                                    scope: n,
                                    request: {
                                ...
                                a.push({
                                    signature: R.default.decode(i.signature)
                                })
                            }
                            return a
                        }
                        ...
                        g.set(this, async (...e) => {
                            if (!this.scope)
                                throw new Error("Not connected");
                            const r = [];
                            for (const {transaction: n, account: s} of e) {
                                ...
                                r.push({
                                    signedTransaction: Uint8Array.from(t.from(i.signedTransaction, "base64"))
                                })
                            }
                            return r
                        }
                        ...
                        m.set(this, async (...e) => {
                            if (!this.scope)
                                throw new Error("Not connected");
                            const r = [];
                            for (const {message: n, account: s} of e) {
                                const e = t.from(n).toString("base64")
                                  , i = await this.client.invokeMethod({
                                    scope: this.scope,
                                    request: {
                                ...
                                r.push({
                                    signedMessage: t.from(i.signedMessage, "base64"),
                                    signature: R.default.decode(i.signature),
                        ...
                        b.set(this, e => {
                            const t = _(this, o, "f")?.address
                              , r = e[0]?.chain;
                            for (const {account: {address: n}, chain: s} of e) {
                                if (n !== t)
                        ...
                        E.set(this, async (e, t) => {
                            let r;
                            const n = new Promise(e => {
                                r = e
                            }
                            )
                              , s = this.client.onNotification(e => {
                                if (!(0,
                                T.isAccountChangedEvent)(e))
                                    return;
                              ...
                              , i = await this.client.createSession({
                                optionalScopes: {
                                    [e]: {
                                        ...t ? {
                              ...
                              , o = await Promise.race([n, new Promise(e => setTimeout( () => e(void 0), 200))]);
                            this.updateSession(i, o)
                        }
                        ),
                        this.client = e,
                        this.name = `${r ?? "MetaMask"}`,
                        S(this, i, this.getInitialSelectedAddress(), "f")
                    }
                    updateSession(e, t) {
                        const r = new Set(Object.keys(e?.sessionScopes ?? {}))
                          , s = [N.Scope.MAINNET, N.Scope.DEVNET, N.Scope.TESTNET].find(e => r.has(e));
                        if (!s)
                            return void S(this, o, void 0, "f");
                        const i = e?.sessionScopes[s]?.accounts;
                        if (!i?.[0])
                            return void S(this, o, void 0, "f");
                        let a;
                        a = t && i.includes(`${s}:${t}`) ? t : _(this, o, "f")?.address && i.includes(`${s}:${_(this, o, "f")?.address}`) ? _(this, o, "f").address : (0,
                        T.getAddressFromCaipAccountId)(i[0]),
                        S(this, o, _(this, n, "m", w).call(this, a), "f"),
                        this.scope = s,
                        _(this, n, "m", u).call(this, "change", {
                            accounts: this.accounts
                        })
                ...
                n = new WeakSet,
                u = function(e, ...t) {
                    for (const r of _(this, s, "f")[e] ?? [])
                        r.apply(null, t)
                }
                ,
                l = function(e, t) {
                    _(this, s, "f")[e] = _(this, s, "f")[e]?.filter(e => t !== e)
                }
                ,
                y = async function(e) {
                    if (!(0,
                    ...
                    const t = e?.params?.notification?.params?.[0];
                    if (!t)
                        return void await _(this, h, "f").call(this, {
                            revokeSession: !1
                        });
                ...
                w = function(e) {
                    return new P({
                        address: e,
                        publicKey: new Uint8Array(R.default.decode(e)),
                        chains: this.chains
                    })
                }
            }
    ...
    , {
        ...
        "./utils.cjs": 54,
        "@solana/wallet-standard-chains": 92,
        "@solana/wallet-standard-features": 93,
        "@wallet-standard/features": 102,
        "@wallet-standard/wallet": 103,
        bs58: 110,
        buffer: 108
    }],
    ...
    , {
        "./error.cjs": 56,
        "./struct.cjs": 58,
        "./structs/coercions.cjs": 59,
        "./structs/refinements.cjs": 60,
        "./structs/types.cjs": 61,
        "./structs/utilities.cjs": 62
    }],
    58: [function(e, t, r) {
        "use strict";
        Object.defineProperty(r, "__esModule", {
        ...
        r.ExactOptionalStruct = class extends i {
            ...
            static isExactOptional(e) {
                return (0,
                s.isObject)(e) && "brand"in e && e.brand === o
            }
        }
        ,
        r.assert = a,
                ...
                *entries(i) {
                    ...
                    s.isObject)(i)) {
                        ...
                        for (const r of t) {
                            s.delete(r);
                            const t = e[r];
                            n.ExactOptionalStruct.isExactOptional(t) && !Object.prototype.hasOwnProperty.call(i, r) || (yield[r, i[r], e[r]])
                        }
                        for (const e of s)
                            yield[e, i[e], r]
                    }
    ...
    66: [function(e, t, r) {
        (function(t) {
            (function() {
                ...
                function c(e) {
                    (0,
                    s.assert)(a(e), "Value must be a Uint8Array.")
                }
                function u(e) {
                    if (c(e),
                    0 === e.length)
                ...
                function g(e) {
                    ...
                    if ("number" == typeof e)
                        return h(e);
                    if ("string" == typeof e)
                        return e.startsWith("0x") ? d(e) : p(e);
                    if (a(e))
                        return e;
    ...
    73: [function(e, t, r) {
        ...
        function y(e) {
            (0,
            a.assert)(m(e), "Invalid hex address.");
        ...
        r.isHexString = h,
        r.isStrictHexString = p,
        r.isHexAddress = g,
        r.isHexChecksumAddress = m,
        r.assertIsHexString = function(e) {
            (0,
            a.assert)(h(e), "Value must be a hexadecimal string.")
        }
        ,
        r.assertIsStrictHexString = function(e) {
            (0,
            a.assert)(p(e), 'Value must be a hexadecimal string, starting with "0x".')
        }
        ,
        r.getChecksumAddressUnmemoized = y,
        r.getChecksumAddress = (0,
        o.default)(y),
        r.isValidChecksumAddressUnmemoized = w,
        r.isValidChecksumAddress = (0,
        o.default)(w),
        r.isValidHexAddressUnmemoized = b,
    ...
    74: [function(e, t, r) {
        ...
        r.remove0x = r.add0x = r.isValidChecksumAddress = r.getChecksumAddress = r.isValidHexAddress = r.assertIsStrictHexString = r.assertIsHexString = r.isHexChecksumAddress = r.isHexAddress = r.isStrictHexString = r.isHexString = r.HexChecksumAddressStruct = r.HexAddressStruct = r.StrictHexStruct = r.HexStruct = void 0,
        s(e("./assert.cjs"), r),
        s(e("./base64.cjs"), r),
        s(e("./bytes.cjs"), r),
    ...
    86: [function(e, t, r) {
        var n = "__lodash_hash_undefined__"
          ...
          , a = "object" == typeof globalThis && globalThis && globalThis.Object === Object && globalThis
          , c = "object" == typeof self && self && self.Object === Object && self
          , u = a || c || Function("return this")();
        var l, d = Array.prototype, f = Function.prototype, h = Object.prototype, p = u["__core-js_shared__"], g = (l = /[^.]+$/.exec(p && p.keys && p.keys.IE_PROTO || "")) ? "Symbol(src)_1." + l : "", m = f.toString, y = h.hasOwnProperty, w = h.toString, b = RegExp("^" + m.call(y).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), v = d.splice, E = R(u, "Map"), _ = R(Object, "create");
        function S(e) {
            var t = -1
              , r = e ? e.length : 0;
            for (this.clear(); ++t < r; ) {
        ...
        function C(e, t) {
            var r, n, s = e.__data__;
            return ("string" == (n = typeof (r = t)) || "number" == n || "symbol" == n || "boolean" == n ? "__proto__" !== r : null === r) ? s["string" == typeof t ? "string" : "hash"] : s.map
        }
        function R(e, t) {
            var r = function(e, t) {
        ...
        function O(e, t) {
            ...
            var r = function() {
                ...
                return r.cache = i.set(s, o),
                o
            };
            return r.cache = new (O.Cache || j),
            r
        }
        function N(e, t) {
            return e === t || e != e && t != t
        ...
        S.prototype.set = function(e, t) {
            return this.__data__[e] = _ && void 0 === t ? n : t,
            this
        }
        ,
        ...
        M.prototype.delete = function(e) {
            var t = this.__data__
              , r = A(t, e);
            return !(r < 0) && (r == t.length - 1 ? t.pop() : v.call(t, r, 1),
            !0)
        }
        ,
    ...
    87: [function(e, t, r) {
        ...
        r.add4L = S;
        const M = (e, t, r, n, s) => t + r + n + s + (e / 2 ** 32 | 0) | 0;
        r.add4H = M;
        const j = (e, t, r, n, s) => (e >>> 0) + (t >>> 0) + (r >>> 0) + (n >>> 0) + (s >>> 0);
        r.add5L = j;
        const A = (e, t, r, n, s, i) => t + r + n + s + i + (e / 2 ** 32 | 0) | 0;
        r.add5H = A;
        const I = {
            fromBig: i,
            split: o,
    ...
    89: [function(e, t, r) {
        ...
        class v extends s.Hash {
            ...
            update(e) {
                ...
                const {blockLen: t, state: r} = this
                  , n = e.length;
                for (let s = 0; s < n; ) {
                    const i = Math.min(t - this.pos, n - s);
                    for (let t = 0; t < i; t++)
                        r[this.pos++] ^= e[s++];
        ...
        const _ = (e, t, r) => (0,
        s.createXOFer)( (n={}) => new v(t,e,void 0 === n.dkLen ? r : n.dkLen,!0));
    ...
    90: [function(e, t, r) {
        ...
        r.hexToBytes = function(e) {
            ...
            s += 2) {
                const r = f(e.charCodeAt(s))
                  , i = f(e.charCodeAt(s + 1));
    ...
    91: [function(e, t, r) {
        ...
        function E(e, t, r, n) {
            ...
            if (b(t, r) > 32)
                throw new Error(`convertRadix2: carry overflow from=${t} to=${r} carryBits=${b(t, r)}`);
            let s = 0
              , i = 0;
            const o = v[t]
              , a = v[r] - 1
        ...
        r.base32 = f(S(5), h("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"), g(5), p("")),
        r.base32nopad = f(S(5), h("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"), p("")),
        r.base32hex = f(S(5), h("0123456789ABCDEFGHIJKLMNOPQRSTUV"), g(5), p("")),
        r.base32hexnopad = f(S(5), h("0123456789ABCDEFGHIJKLMNOPQRSTUV"), p("")),
        r.base32crockford = f(S(5), h("0123456789ABCDEFGHJKMNPQRSTVWXYZ"), p(""), m(e => e.toUpperCase().replace(/O/g, "0").replace(/[IL]/g, "1")));
        ...
        } : f(S(6), h("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), g(6), p("")),
        ...
        } : f(S(6), h("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"), g(6), p("")),
        r.base64urlnopad = f(S(6), h("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"), p(""));
        const I = e => f(_(58), h(e), p(""));
        ...
        r.createBase58check = e => f(j(4, t => e(e(t))), r.base58),
        r.base58check = r.createBase58check;
        const R = f(h("qpzry9x8gf2tvdw0s3jn54khce6mua7l"), p(""))
        ...
        function T(e, t, r=1) {
            ...
            s = N(s);
            for (let t = 0; t < n; t++)
                s = N(s) ^ 31 & e.charCodeAt(t);
            for (let e of t)
                s = N(s) ^ e;
            for (let e = 0; e < 6; e++)
                s = N(s);
            return s ^= r,
            R.encode(E([s % v[30]], 30, 5, !1))
        }
        function P(e) {
            ...
            function c(e, r, s=90) {
                ...
                if (!1 !== s && o > s)
                    throw new TypeError(`Length ${o} exceeds limit ${s}`);
                const c = e.toLowerCase()
                  , u = T(c, r, t);
                return `${c}1${R.encode(r)}${u}`
            }
            function u(e, r=90) {
        ...
        r.hex = x ? k : f(S(4), h("0123456789abcdef"), p(""), m(e => {
    ...
    93: [function(e, t, r) {
        ...
        s(e("./signAndSendTransaction.js"), r),
        s(e("./signIn.js"), r),
        s(e("./signMessage.js"), r),
        s(e("./signTransaction.js"), r),
        s(e("./signAndSendAllTransactions.js"), r)
    }
    , {
        "./signAndSendAllTransactions.js": 94,
        "./signAndSendTransaction.js": 95,
        "./signIn.js": 96,
        "./signMessage.js": 97,
        "./signTransaction.js": 98
    }],
    94: [function(e, t, r) {
        "use strict";
        Object.defineProperty(r, "__esModule", {
    ...
    104: [function(e, t, r) {
        "use strict";
        var n, s = this && this.__classPrivateFieldGet || function(e, t, r, n) {
            if ("a" === r && !n)
                throw new TypeError("Private accessor was defined without a getter");
            if ("function" == typeof t ? e !== t || !n : !t.has(e))
                throw new TypeError("Cannot read private member from an object whose class did not declare it");
    ...
    105: [function(e, t, r) {
        "use strict";
        var n, s, i, o, a, c, u = this && this.__classPrivateFieldGet || function(e, t, r, n) {
            if ("a" === r && !n)
                throw new TypeError("Private accessor was defined without a getter");
            if ("function" == typeof t ? e !== t || !n : !t.has(e))
                throw new TypeError("Cannot read private member from an object whose class did not declare it");
        ...
        , l = this && this.__classPrivateFieldSet || function(e, t, r, n, s) {
            if ("m" === n)
                throw new TypeError("Private method is not writable");
            if ("a" === n && !s)
                throw new TypeError("Private accessor was defined without a setter");
        ...
        class d {
            ...
            constructor(e) {
                ...
                l(this, s, e.publicKey.slice(), "f"),
                l(this, i, e.chains.slice(), "f"),
                l(this, o, e.features.slice(), "f"),
                l(this, a, e.label, "f"),
                l(this, c, e.icon, "f")
            }
        }
 ...
 */
        ...
        function c(e, t, r) {
            ...
            var s = function(e) {
                ...
                if (void 0 !== e.length)
                    return "number" != typeof e.length || F(e.length) ? o(0) : d(e);
        ...
        function j(e, t, r) {
            ...
            for (var n = [], s = t; s < r; ) {
                var i, o, a, c, u = e[s], l = null, d = u > 239 ? 4 : u > 223 ? 3 : u > 191 ? 2 : 1;
                if (s + d <= r)
                    switch (d) {
                    case 1:
                        u < 128 && (l = u);
        ...
        a.prototype.compare = function(e, t, r, n, s) {
            ...
            if (this === e)
                return 0;
            for (var i = (s >>>= 0) - (n >>>= 0), o = (r >>>= 0) - (t >>>= 0), c = Math.min(i, o), u = this.slice(n, s), l = e.slice(t, r), d = 0; d < c; ++d)
                if (u[d] !== l[d]) {
                    i = u[d],
                    o = l[d];
                    break
    ...
    110: [function(e, t, r) {
        ...
        var s = n(e("base-x"));
        r.default = (0,
        s.default)("123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz")
    }
    , {
        "base-x": 109
    }],
    ...
    115: [function(e, t, r) {
        ...
        function c(e, t, r, n) {
            ...
            l(e, "", 0, [], void 0, 0, n);
            try {
                s = 0 === o.length ? JSON.stringify(e, t, r) : JSON.stringify(e, p(t), r)
            } catch (e) {
        ...
        function f(e, t, r, n) {
            void 0 === n && (n = a());
            var s, c = h(e, "", 0, [], void 0, 0, n) || e;
            try {
                s = 0 === o.length ? JSON.stringify(c, t, r) : JSON.stringify(c, p(t), r)
            } catch (e) {
                return JSON.stringify("[unable to serialize, circular reference is too complex to analyze]")
            } finally {
                for (; 0 !== i.length; ) {
    ...
    116: [function(e, t, r) {
        ...
        r.read = function(e, t, r, n, s) {
            var i, o, a = 8 * s - n - 1, c = (1 << a) - 1, u = c >> 1, l = -7, d = r ? s - 1 : 0, f = r ? -1 : 1, h = e[t + d];
            for (d += f,
            i = h & (1 << -l) - 1,
            h >>= -l,
            l += a; l > 0; i = 256 * i + e[t + d],
            d += f,
            l -= 8)
                ;
            for (o = i & (1 << -l) - 1,
            i >>= -l,
            l += n; l > 0; o = 256 * o + e[t + d],
            d += f,
            l -= 8)
                ;
            if (0 === i)
        ...
        r.write = function(e, t, r, n, s, i) {
            var o, a, c, u = 8 * i - s - 1, l = (1 << u) - 1, d = l >> 1, f = 23 === s ? Math.pow(2, -24) - Math.pow(2, -77) : 0, h = n ? 0 : i - 1, p = n ? 1 : -1, g = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
            for (t = Math.abs(t),
            isNaN(t) || t === 1 / 0 ? (a = isNaN(t) ? 1 : 0,
            o = l) : (o = Math.floor(Math.log(t) / Math.LN2),
            t * (c = Math.pow(2, -o)) < 1 && (o--,
            c *= 2),
            (t += o + d >= 1 ? f / c : f * Math.pow(2, 1 - d)) * c >= 2 && (o++,
            c /= 2),
            o + d >= l ? (a = 0,
            o = l) : o + d >= 1 ? (a = (t * c - 1) * Math.pow(2, s),
    ...
    118: [function(e, t, r) {
        !function(e, r) {
            ...
            (i = new d).getLogger = function(e) {
                ...
                var t = s[e];
                return t || (t = s[e] = new d(e,i.methodFactory)),
                t
            }
            ;
    ...
    128: [function(e, t, r) {
        (function(r, n) {
            (function() {
                ...
                ;
                var d, f, h, p = e("./internal/streams/buffer_list"), g = e("./internal/streams/destroy"), m = e("./internal/streams/state").getHighWaterMark, y = e("../errors").codes, w = y.ERR_INVALID_ARG_TYPE, b = y.ERR_STREAM_PUSH_AFTER_EOF, v = y.ERR_METHOD_NOT_IMPLEMENTED, E = y.ERR_STREAM_UNSHIFT_AFTER_END_EVENT;
                e("inherits")(j, o);
                ...
                function A(e, t, r, n, s) {
                    ...
                    if (null === t)
                        ...
                        var r;
                        n = t,
                        a.isBuffer(n) || n instanceof c || "string" == typeof t || void 0 === t || e.objectMode || (r = new w("chunk",["string", "Buffer", "Uint8Array"],t));
                        var n;
                        return r
                    }(o, t)),
                    i)
                        ...
                        n)
                            o.endEmitted ? _(e, new E) : I(e, o, t, !0);
                        else if (o.ended)
                            _(e, new b);
                        else {
                            if (o.destroyed)
                            ...
                            o.objectMode || 0 !== t.length ? I(e, o, t, !1) : T(e, o)) : I(e, o, t, !1)
                        }
                    else
                        n || (o.reading = !1,
                        T(e, o));
                ...
                j.prototype.pipe = function(e, t) {
                    ...
                    function f(t) {
                        ...
                        var r = e.write(t);
                        u("dest.write", r),
                        !1 === r && ((1 === s.pipesCount && s.pipes === e || s.pipesCount > 1 && -1 !== B(s.pipes, e)) && !d && (u("false write response, pause", s.awaitDrain),
                        s.awaitDrain++),
                        n.pause())
                    }
                    function h(t) {
                ...
                j.prototype.on = function(e, t) {
                    ...
                    s.length ? O(this) : s.reading || r.nextTick(k, this))),
                    n
                }
                ,
    ...
    130: [function(e, t, r) {
        (function(r, n) {
            (function() {
                ...
                ;
                var l, d = e("./internal/streams/destroy"), f = e("./internal/streams/state").getHighWaterMark, h = e("../errors").codes, p = h.ERR_INVALID_ARG_TYPE, g = h.ERR_METHOD_NOT_IMPLEMENTED, m = h.ERR_MULTIPLE_CALLBACK, y = h.ERR_STREAM_CANNOT_PIPE, w = h.ERR_STREAM_DESTROYED, b = h.ERR_STREAM_NULL_VALUES, v = h.ERR_STREAM_WRITE_AFTER_END, E = h.ERR_UNKNOWN_ENCODING, _ = d.errorOrDestroy;
                function S() {}
                function M(t, n, o) {
                    ...
                    this.onwrite = function(e) {
                        !function(e, t) {
                            ...
                            t)
                                ...
                                s ? r.nextTick(I, e, n, o, i) : I(e, n, o, i)
                            }
                        }(n, e)
                    }
                    ,
                ...
                function A(e, t, r, n, s, i, o) {
                    ...
                    t.writing = !0,
                    t.sync = !0,
                    t.destroyed ? t.onwrite(new w("write")) : r ? e._writev(s, t.onwrite) : e._write(s, i, t.onwrite),
                    t.sync = !1
                }
                function I(e, t, r, n) {
                    r || function(e, t) {
                ...
                j.prototype.write = function(e, t, n) {
                    ...
                    i.ending ? function(e, t) {
                        ...
                        var i;
                        return null === n ? i = new b : "string" == typeof n || t.objectMode || (i = new p("chunk",["string", "Buffer"],n)),
                        !i || (_(e, i),
                        r.nextTick(s, i),
                        !1)
    ...
    142: [function(e, t, r) {
        ...
        class s {
            ...
            parseRange(e) {
                ...
                c("caret trim", e);
                let o = e.split(" ").map(e => v(e, this.options)).join(" ").split(/\s+/).map(e => R(e, this.options));
                n && (o = o.filter(e => (c("loose invalid filter", e, this.options),
                !!e.match(l[d.COMPARATORLOOSE])))),
                c("range list", o);
                const u = new Map
                  , w = o.map(e => new a(e,this.options));
                for (const e of w) {
                    if (y(e))
                        return [e];
                    u.set(e.value, e)
        ...
        e.split(/\s+/).map(e => I(e, t)).join(" "))
          , I = (e, t) => {
            ...
            return e.replace(r, (r, n, s, i, o, a) => {
                ...
                l ? s = +s + 1 : i = +i + 1),
                "<" === n && (a = "-0"),
                r = `${n + s}.${i}.${o}${a}`) : l ? r = `>=${s}.0.0${a} <${+s + 1}.0.0-0` : d && (r = `>=${s}.${i}.0${a} <${s}.${+i + 1}.0-0`),
                c("xRange return", r),
                r
            }
            )
        ...
        e.trim().replace(l[d.STAR], ""))
          , R = (e, t) => (c("replaceGTE0", e, t),
        e.trim().replace(l[t.includePrerelease ? d.GTE0PRE : d.GTE0], ""))
          , O = e => (t, r, n, s, i, o, a, c, u, l, d, f) => `${r = E(n) ? "" : E(s) ? `>=${n}.0.0${e ? "-0" : ""}` : E(i) ? `>=${n}.${s}.0${e ? "-0" : ""}` : o ? `>=${r}` : `>=${r}${e ? "-0" : ""}`} ${c = E(u) ? "" : E(l) ? `<${+u + 1}.0.0-0` : E(d) ? `<${u}.${+l + 1}.0-0` : f ? `<=${u}.${l}.${d}-${f}` : e ? `<${u}.${l}.${+d + 1}-0` : `<=${c}`}`.trim()
          , N = (e, t, r) => {
            for (let r = 0; r < e.length; r++)
                if (!e[r].test(t))
                    return !1;
        ...
        class l {
            ...
            inc(e, t, r) {
                if (e.startsWith("pre")) {
                    ...
                    if (t) {
                        const e = `-${t}`.match(this.options.loose ? o[a.PRERELEASELOOSE] : o[a.PRERELEASE]);
                        if (!e || e[1] !== t)
    ...
    168: [function(e, t, r) {
        ...
        const n = e("./internal/re")
          ...
          , I = e("./functions/lte")
          , C = e("./functions/cmp")
          , R = e("./functions/coerce")
          , O = e("./classes/comparator")
          , N = e("./classes/range")
          , T = e("./functions/satisfies")
    ...
    174: [function(e, t, r) {
        ...
        g("MAINVERSION", `(${u[d.NUMERICIDENTIFIER]})\\.(${u[d.NUMERICIDENTIFIER]})\\.(${u[d.NUMERICIDENTIFIER]})`),
        g("MAINVERSIONLOOSE", `(${u[d.NUMERICIDENTIFIERLOOSE]})\\.(${u[d.NUMERICIDENTIFIERLOOSE]})\\.(${u[d.NUMERICIDENTIFIERLOOSE]})`),
        g("PRERELEASEIDENTIFIER", `(?:${u[d.NONNUMERICIDENTIFIER]}|${u[d.NUMERICIDENTIFIER]})`),
        g("PRERELEASEIDENTIFIERLOOSE", `(?:${u[d.NONNUMERICIDENTIFIER]}|${u[d.NUMERICIDENTIFIERLOOSE]})`),
        g("PRERELEASE", `(?:-(${u[d.PRERELEASEIDENTIFIER]}(?:\\.${u[d.PRERELEASEIDENTIFIER]})*))`),
        g("PRERELEASELOOSE", `(?:-?(${u[d.PRERELEASEIDENTIFIERLOOSE]}(?:\\.${u[d.PRERELEASEIDENTIFIERLOOSE]})*))`),
        g("BUILDIDENTIFIER", `${h}+`),
        g("BUILD", `(?:\\+(${u[d.BUILDIDENTIFIER]}(?:\\.${u[d.BUILDIDENTIFIER]})*))`),
        g("FULLPLAIN", `v?${u[d.MAINVERSION]}${u[d.PRERELEASE]}?${u[d.BUILD]}?`),
        g("FULL", `^${u[d.FULLPLAIN]}$`),
        g("LOOSEPLAIN", `[v=\\s]*${u[d.MAINVERSIONLOOSE]}${u[d.PRERELEASELOOSE]}?${u[d.BUILD]}?`),
        g("LOOSE", `^${u[d.LOOSEPLAIN]}$`),
        g("GTLT", "((?:<|>)?=?)"),
        g("XRANGEIDENTIFIERLOOSE", `${u[d.NUMERICIDENTIFIERLOOSE]}|x|X|\\*`),
        g("XRANGEIDENTIFIER", `${u[d.NUMERICIDENTIFIER]}|x|X|\\*`),
        g("XRANGEPLAIN", `[v=\\s]*(${u[d.XRANGEIDENTIFIER]})(?:\\.(${u[d.XRANGEIDENTIFIER]})(?:\\.(${u[d.XRANGEIDENTIFIER]})(?:${u[d.PRERELEASE]})?${u[d.BUILD]}?)?)?`),
        g("XRANGEPLAINLOOSE", `[v=\\s]*(${u[d.XRANGEIDENTIFIERLOOSE]})(?:\\.(${u[d.XRANGEIDENTIFIERLOOSE]})(?:\\.(${u[d.XRANGEIDENTIFIERLOOSE]})(?:${u[d.PRERELEASELOOSE]})?${u[d.BUILD]}?)?)?`),
        g("XRANGE", `^${u[d.GTLT]}\\s*${u[d.XRANGEPLAIN]}$`),
        g("XRANGELOOSE", `^${u[d.GTLT]}\\s*${u[d.XRANGEPLAINLOOSE]}$`),
        g("COERCEPLAIN", `(^|[^\\d])(\\d{1,${n}})(?:\\.(\\d{1,${n}}))?(?:\\.(\\d{1,${n}}))?`),
        g("COERCE", `${u[d.COERCEPLAIN]}(?:$|[^\\d])`),
        g("COERCEFULL", u[d.COERCEPLAIN] + `(?:${u[d.PRERELEASE]})?` + `(?:${u[d.BUILD]})?(?:$|[^\\d])`),
        g("COERCERTL", u[d.COERCE], !0),
        g("COERCERTLFULL", u[d.COERCEFULL], !0),
        g("LONETILDE", "(?:~>?)"),
        g("TILDETRIM", `(\\s*)${u[d.LONETILDE]}\\s+`, !0),
        r.tildeTrimReplace = "$1~",
        g("TILDE", `^${u[d.LONETILDE]}${u[d.XRANGEPLAIN]}$`),
        g("TILDELOOSE", `^${u[d.LONETILDE]}${u[d.XRANGEPLAINLOOSE]}$`),
        g("LONECARET", "(?:\\^)"),
        g("CARETTRIM", `(\\s*)${u[d.LONECARET]}\\s+`, !0),
        r.caretTrimReplace = "$1^",
        g("CARET", `^${u[d.LONECARET]}${u[d.XRANGEPLAIN]}$`),
        g("CARETLOOSE", `^${u[d.LONECARET]}${u[d.XRANGEPLAINLOOSE]}$`),
        g("COMPARATORLOOSE", `^${u[d.GTLT]}\\s*(${u[d.LOOSEPLAIN]})$|^$`),
        g("COMPARATOR", `^${u[d.GTLT]}\\s*(${u[d.FULLPLAIN]})$|^$`),
        g("COMPARATORTRIM", `(\\s*)${u[d.GTLT]}\\s*(${u[d.LOOSEPLAIN]}|${u[d.XRANGEPLAIN]})`, !0),
        r.comparatorTrimReplace = "$1$2$3",
        g("HYPHENRANGE", `^\\s*(${u[d.XRANGEPLAIN]})\\s+-\\s+(${u[d.XRANGEPLAIN]})\\s*$`),
        g("HYPHENRANGELOOSE", `^\\s*(${u[d.XRANGEPLAINLOOSE]})\\s+-\\s+(${u[d.XRANGEPLAINLOOSE]})\\s*$`),
        g("STAR", "(<|>)?=?\\s*\\*"),
        g("GTE0", "^\\s*>=\\s*0\\.0\\.0\\s*$"),
        ...
        const n = e("../classes/range.js")
          ...
          , l = (e, t, r) => {
            ...
            if (n.size > 1)
                return null;
            if (s && l) {
                if (h = a(s.semver, l.semver, r),
                h > 0)
                    return null;
                if (0 === h && (">=" !== s.operator || "<=" !== l.operator))
                    return null
            }
            for (const e of n) {
                if (s && !o(e, String(s), r))
            ...
            let w = !(!l || r.includePrerelease || !l.semver.prerelease.length) && l.semver
              , b = !(!s || r.includePrerelease || !s.semver.prerelease.length) && s.semver;
            w && 1 === w.prerelease.length && "<" === l.operator && 0 === w.prerelease[0] && (w = !1);
            for (const e of t) {
                ...
                if (l)
                    ...
                    "<" === e.operator || "<=" === e.operator) {
                        ...
                        return !1;
                if (!e.operator && (l || s) && 0 !== h)
                    return !1
            }
            return !(s && m && !l && 0 !== h) && (!(l && y && !s && 0 !== h) && (!b && !w))
        }
          , d = (e, t, r) => {
            if (!e)
                return t;
